...
@Designate(ocd = PathImpl.Cfg.class)
public class PathImpl extends AbstractComputedProperty<String> {
    public static final String LABEL = "Asset Path";
    ...
    @ObjectClassDefinition(name = "Asset Share Commons - Computed Property - Asset Path")
